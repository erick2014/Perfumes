<?php require("listarEtiquetas.php");?>
...
<script src="../../js/validaciones/validarEtiquetas.js" type="text/javascript"></script>

</head>
<body>
<input type="hidden" id="urlDelete" value="eliminarE.php" />
<div id="mensaje"></div>
<div id="GENERAL">
 	...
 	<div id="CONTENIDO"><a href="./menucss.php" class="btn1">VOLVER AL MENU PRINCIPAL </a><br />
         <div id="INFORMACION_PAGINA">
                  <div class="div_tablas" id="DIV_TABLA1">
                      <div  id="Nuevo"  class="btn1">Nueva etiqueta</div> <br/><br/>
...
<div id="contenedorform">
  <form id="Etiquetas" name="Etiquetas" class="form" >
    <!--links -->
    <input type="hidden" id="url_save_registro"  />
    <input type="hidden" id="codEtiquetaViejo" name="codEtiquetaViejo" />
    <input type="hidden" name='pos' id='pos' />
    <table>
        <tr>
            <td>Codigo</td>
            <td><input name='codigoEtiqueta' id='codigoEtiqueta' class="required" /></td>
        </tr>
        <tr>
            <td>Etiqueta</td>
            <td><input name='etiqueta' id='etiqueta' class="required " /></td>
        </tr>
        <tr>
            <td>Descripcion</td>
