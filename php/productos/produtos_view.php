<?php require("listarProductos.php");?>
...
<body>
<input type="hidden" id="urlDelete" value="eliminarP.php" />
<div id="mensaje"></div>
<div id="GENERAL">
 	...
 	<div id="CONTENIDO"><a href="./menucss.php" class="btn1">VOLVER AL MENU PRINCIPAL </a><br />
         <div id="INFORMACION_PAGINA">
                  <div class="div_tablas" id="DIV_TABLA1">
                      <div  id="Nuevo"  class="btn1">Nuevo producto</div> <br/><br/>
...
<div id="contenedorform">
  <form id="producto" name="producto" class="form" >
    <!--links -->
    <input type="hidden" id="url_save_registro"  />
    <input type="hidden" id="tipoP" name="tipoP" clas="required" />
    <input type="hidden" id="codProductoViejo" name="codProductoViejo" />
    <input type="hidden" name='pos' id='pos' />
    <table>
        <tr>
            <td>Codigo</td>
            <td><input name='codigoProducto' id='codigoProducto' class="required buscar" /></td>
        </tr>
        <tr>
            <td>Nombre</td>
        ...
        <tr>
            <td>Tipo</td>
            <td>
                <?php echo "<select id='codigo_tipo' name='codigo_tipo' class='required'>".
