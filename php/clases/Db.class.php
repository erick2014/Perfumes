...
class Db {
  ...
  /**/
   ...
   public function insertar($tabla,$campas,$variable){
                             $this->stmt = '';
                             $sqlinsertar = "INSERT INTO ".$tabla." (".$campas.")
                               VALUES (".$variable.")";
                  
                              $this->stmt=mysql_query($sqlinsertar,$this->link);
                              }
   ...
   public function actualizar($tabla,$campavariable,$condicion){
                                ...
                                $this->stmt=mysql_query($sqlactualizar,$this->link);
                               }

   public function eliminar($tabla,$variable){
                              $this->stmt = '';
                              $sqleliminar = 'DELETE FROM '.$tabla.'  Where '.$variable;
                              $this->stmt=mysql_query($sqleliminar,$this->link);
                             }
