...
<script src="../../js/validaciones/validarF.js" type="text/javascript"></script>

</head>
<body>
<input type="hidden" id="urlDelete" value="eliminarF.php" />
<div id="mensaje"></div>
<div id="GENERAL">
 	...
 	<div id="CONTENIDO"><a href="./menucss.php" class="btn1">VOLVER AL MENU PRINCIPAL </a><br />
         <div id="INFORMACION_PAGINA">
                  <div class="div_tablas" id="DIV_TABLA1">
                      <div  id="Nuevo"  class="btn1">Nuevo frasco</div> <br/><br/>
...
<div id="contenedorform">
  <form id="Usuario" name="Usuario" class="form" >
    ...
    <input type="hidden" id="codFViejo" name="codFViejo" />
    <input type="hidden" name='pos' id='pos' />
    <table>
        <tr>
            <td>Codigo</td>
            <td><input name='codigoFrasco' id='codigoFrasco' class="required" /></td>
        </tr>
        <tr>
            <td>Frasco</td>
            <td><input name='frasco' id='frasco' class="required " /></td>
        </tr>
        <tr>
            <td>Medidas</td>
            <td><input name='medidas' id='medidas' class="required " /></td>
        </tr>
        <tr>
            <td>Descripcion</td>
