...
<script src="../../js/validaciones/validarDPR.js" type="text/javascript"></script>

</head>
<body>
<input type="hidden" id="urlDelete" value="eliminarDPR.php" />
<div id="mensaje"></div>
<div id="GENERAL">
 	...
 	<div id="CONTENIDO"><a href="./menucss.php" class="btn1">VOLVER AL MENU PRINCIPAL </a><br />
         <div id="INFORMACION_PAGINA">
                  <div class="div_tablas" id="DIV_TABLA1">
                      <div  id="Nuevo"  class="btn1">Nuevo detalle ropa</div> <br/><br/>
...
<div id="contenedorform">
  <form id="detallePR" name="detallePR" class="form" >
    <!--links -->
...
<!--        <tr>
            ...
            <td>
                <input name="codigoDetalleRopa" id="codigoDetalleRopa" class="required" />
        ...
        <tr>
         ...
         <tr>
            <td>Color</td>
            <td><input name='color' id='color' class="required" /></td>
        </tr>
        <tr>
            <td>Talla</td>
            <td><input name='talla' id='talla' class="required" /></td>
        </tr>
        <tr>
            <td>Descripcion</td>
